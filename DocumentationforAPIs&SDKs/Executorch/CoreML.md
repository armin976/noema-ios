...
See [Partitioner API](https://docs.pytorch.org/executorch/1.1/backends/coreml/coreml-partitioner.html) for a reference on available partitioner options.

## Quantization

The Core ML delegate can also be used as a backend to execute quantized models. See [Core ML Quantization](https://docs.pytorch.org/executorch/1.1/backends/coreml/coreml-quantization.html) for more information on available quantization schemes and APIs.
...
To run the model on device, use the standard ExecuTorch runtime APIs. See [Running on Device](https://docs.pytorch.org/executorch/1.1/using-executorch-ios.html) for more information, including building the iOS frameworks.
...
* → [Troubleshooting](https://docs.pytorch.org/executorch/1.1/backends/coreml/coreml-troubleshooting.html) — Debug common issues.
* → [Partitioner API](https://docs.pytorch.org/executorch/1.1/backends/coreml/coreml-partitioner.html) — Partitioner options.
* → [Quantization](https://docs.pytorch.org/executorch/1.1/backends/coreml/coreml-quantization.html) — Supported quantization schemes.
* → [Op support](https://docs.pytorch.org/executorch/1.1/backends/coreml/coreml-op-support.html) — Supported operators.
