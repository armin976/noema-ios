        ...
        NavigationStack {
            List {
                ...
                Section {
                    ...
                    let useButtonDisabled = disabledForSLM || disabledForRemote
                                ...
                                Button("Use Dataset") { }
                                    ...
                                    .overlay(
                                        Color.clear
                                            ...
                                            .onTapGesture {
                                                disabledUseReason = disabledForRemote ? remoteUseDatasetReason : slmUseDatasetReason
            ...
            .alert("Unavailable", isPresented: $showDisabledUseReason) {
                Button("OK", role: .cancel) { disabledUseReason = "" }
            } message: {
...
private extension LocalDatasetDetailView {
    var slmUseDatasetReason: String { "SLM models aren't yet RAG compatible." }
    var remoteUseDatasetReason: String { "Remote models can’t use datasets yet." }
