...
@MainActor struct MathRenderTuning {
    ...
    // actually tall.
    static var inlineInsets: UIEdgeInsets = UIEdgeInsets(top: 2, left: 2, bottom: 2, right: 2)
    static var blockInsets: UIEdgeInsets = UIEdgeInsets(top: 6, left: 4, bottom: 6, right: 4)
}
