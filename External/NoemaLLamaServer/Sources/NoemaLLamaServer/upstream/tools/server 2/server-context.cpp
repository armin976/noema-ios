...
// Bridge callback implemented in bridge/server_bridge.mm.
...
private:
    ...
    bool sleeping = false;
    bool has_reported_http_ready = false;
    ...
    void update_slots() {
        // check if all slots are idle
        {
            ...
            if (all_idle) {
                if (!has_reported_http_ready) {
                    has_reported_http_ready = true;
