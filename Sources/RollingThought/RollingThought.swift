...
public final class RollingThoughtViewModel: ObservableObject {
    ...
    public func toggleExpanded() {
        ...
        case .expanded:
            ...
            phase = didReachLogicalCompletion ? .complete : .streaming
        case .idle:
            break
        }
    }
    ...
    private var streamingView: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            ScrollViewReader { proxy in
                ...
                .frame(height: CGFloat(viewModel.rollingLineLimit) * 14.0)
        ...
        // Fix layout to prevent view jumping - use fixed height
        .frame(height: 90)
        .frame(maxWidth: .infinity, alignment: .leading)
